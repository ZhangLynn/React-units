...
let jsonData={data: {count1: 673, count2: 225, count3: 142, count4: 302, count5: 437}};
export default class PieRcharts extends React.Component{
    constructor(){
        super();
        this.state={
            pieData: {data:[]},
    ...
    getData(){
        ...
        console.log(JSON.stringify(this.state.pieData))
    }
    render(){
        return (
        <div>
